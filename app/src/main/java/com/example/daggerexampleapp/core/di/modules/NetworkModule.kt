...
abstract class NetworkModule {
    ...
    @Binds
    abstract fun bindApiDataProvider(apiDataProvider: ApiDataProviderImpl): ApiDataProvider

    @Binds
    abstract fun bindApiProvider(apiProvider: ApiProviderImpl): ApiProvider
